  ...
  return (
    <div className="px-4 py-8 md:px-6 lg:py-12">
      ...
      <div className="mb-6">
        <Button
          variant="outline"
          className=" items-center gap-2 bg-white hover:bg-gray-100"
          onClick={() => router.back()}
        >
            ...
            <div className="flex items-start gap-6">
              ...
              <div>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <Badge
                    variant="outline"
                    className="bg-green-50 text-green-700 border-green-200 px-2.5 py-0.5"
                  >
                    New
                  </Badge>
                </div>
