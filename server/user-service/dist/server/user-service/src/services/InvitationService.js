...
class InvitationService {
    ...
    async sendInvitation(email, employeeId, role, message) {
        ...
        await this.emailService.sendInvitationEmail(email, token, employee.companyAssociations[0].company.companyName, role);
    ...
    async acceptInvitation(token, name, password) {
        ...
        await this.companyEmployeeRole.assignRole(employee.id, companyId, client_1.CompanyRole[role]);
