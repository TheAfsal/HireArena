...
const AptitudeTestResultSchema = new mongoose_1.Schema({
    totalQuestions: { type: Number, required: true },
    attemptedCount: { type: Number, required: true },
    scorePercentage: { type: Number, required: true },
    status: {
        type: String,
        enum: Object.values(Interview_1.RoundStatus),
        required: true,
    },
...
exports.default = mongoose_1.default.model("AptitudeTestResult", AptitudeTestResultSchema);
